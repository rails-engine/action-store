class User < ActiveRecord::Base
  ...
  action_store :follow, :post, action_class_name: "Follow"
  action_store :like, :comment, counter_cache: true
  action_store :follow, :user, counter_cache: 'followers_count', user_counter_cache: 'following_count', action_class_name: "Follow"
